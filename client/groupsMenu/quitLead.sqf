...
GRPMNU_groupActions = _caller addAction["<t color='#EB7FAF'>Groups Menu</t>", "client\groupsMenu\GroupActions.sqf", nil, -200, false, false, "", "_target == vehicle _this || _target == _this"];
