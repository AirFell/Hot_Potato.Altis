...
player addAction [
	...
	nil, 0.5, True, True, "", "(player distance east_veh_shop) < 3"
];
...
player addAction [
	...
	nil, 0.5, True, True, "", "(player distance east_fort_shop) < 3"
];
...
player addAction [
	...
	nil, 2, True, True, "", "vehicle player != player && (assignedVehicleRole player select 0) == ""Driver"" && ((player distance east_veh_shop_spawn1) < 10 || (player distance east_veh_shop_spawn2) < 10 || (player distance east_veh_shop_spawn3) < 10 || (player distance east_veh_shop_spawn4) < 10 || (player distance east_veh_shop_spawn5) < 10)"
];